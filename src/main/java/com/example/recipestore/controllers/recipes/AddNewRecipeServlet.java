...
public class AddNewRecipeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/recipes/form.jsp");
    ...
    public Recipe generateRecipeFromRequest(HttpServletRequest request){
        ...
        Recipe newRecipe = new Recipe(title, category, prep_time_float, cook_time_float, description, instructions);
        try {
